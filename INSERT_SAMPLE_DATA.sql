...
BEGIN
  ...
  INSERT INTO players (name, school_id, uni_division, club_division, rating) VALUES
    -- 한양대 선수들
    ('김민수', hyu_id, '1부', 0, 1650),
    ('이준호', hyu_id, '1부', 1, 1580),
    ('박서연', hyu_id, '2부', 2, 1520),
    ('최지훈', hyu_id, '1부', 0, 1700),
    ...
    -- 서울대 선수들
    ('오현우', snu_id, '1부', -1, 1720),
    ('신예은', snu_id, '2부', 1, 1550),
    
    -- 성균관대 선수들
    ('조성훈', sku_id, '1부', 1, 1600),
    ('배지은', sku_id, '2부', 2, 1490);
END $$;
